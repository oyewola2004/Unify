...
namespace UNIFY.Implementation.Services
{
    public class SecurityService : ISecurityService
    {
        ...
        public async Task<BaseResponse> DeleteSecurity(string Id)
        {
            var security = await _securityRepository.Get(Id);
            if (security == null) return new BaseResponse
            {
            ...
            await _securityRepository.Delete(security);
        ...
        public async Task<BaseResponse> RegisterSecurity(SecurityDto.SecurityRequestModel model)
        {
            ...
            var role = await _roleRepository.Get(x => x.RoleName == "Security");
            if (role == null)
            {
                return new BaseResponse
                {
