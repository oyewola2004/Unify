    ...
    public class MemberService : IMemberService
    {
        ...
        public async Task<BaseResponse> RegisterMember(MemberRequestModel model)
        {
            ...
            else if (model != null)
            {
                ...
                var emailRequest = new EmailRequestModel
                {
                   ...
                   Message = $"Hi {model.LastName}, You have successfully registered as a Member on UNIFY, We provide a peaceful abode, for your satisfaction. Pls wait for your verification from the admin before login",
        ...
        public async Task<BaseResponse> VerifyMember(string id)
        {
            ...
            var emailRequest = new EmailRequestModel
            {
               ...
               Message = "You have been verified by the admin, you can now proceed to login",
